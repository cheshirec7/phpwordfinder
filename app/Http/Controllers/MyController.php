...
//        }
	...
	private function getWordsArr( int $word_len ): array {
		...
		$wordlist = explode( "*", file_get_contents( "wordlists/wl_" . $word_len . '.txt', false ) );
...
//                    $json_arr[] = array_filter($words_arr);
	...
	function define( $word ) {
		...
		$key = env( 'DICT_KEY' );
		$uri = "https://www.dictionaryapi.com/api/v1/references/collegiate/xml/" .
		       urlencode( $word ) . "?key=" . $key;
